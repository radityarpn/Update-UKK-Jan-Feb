...
<nav class="navbar bg-dark" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">PUSAT PELAPORAN MASYARAKAT</a>
      ...
      <div class="col-md-6 offset-md-3">
        ...
        <div class="card my-5">
          ...
          <form class="card-body cardbody-color p-lg-5">
            ...
            <form action="" method="post" action="simpan_masyarakat.php">
            <div class="mb-3">
              <input type="int" class="form-control" id="NIK" aria-describedby="Nik"
                placeholder="Nik">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <input type="int" class="form-control" id="Nomor Telpon" placeholder="Nomor Telpon">
            </div>
            <div class="text-center"><button type="submit" class="btn btn-dark px-5 mb-5 w-100">Register</a></button></div>
...
if (isset($_POST['kirim'])) {
  ...
  $query = mysqli_query($koneksi, "INSERT INTO masyarakat VALUES ('$nik', '$nama', '$username', 
  '$password', '$telp')");
